...
class RequestVerificationCodeInteractor @Inject constructor(
    ...
    ): Observable<ResetPasswordAction> = actions.ofType<RequestVerificationCode>()
            .observeOn(schedulers.io())
            .flatMapMaybe {
                verifySmsCodeSource.requestPhoneVerificationCode(it.phone)
